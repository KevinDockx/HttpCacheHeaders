...
namespace Marvin.Cache.Headers
{
  public class HttpCacheHeadersMiddleware
  {
    ...
    {
      var expiration = httpContext.GetEndpoint()?.Metadata.FirstOrDefault(m => m is HttpCacheExpirationAttribute);
      var validation = httpContext.GetEndpoint()?.Metadata.FirstOrDefault(m => m is HttpCacheValidationAttribute);
